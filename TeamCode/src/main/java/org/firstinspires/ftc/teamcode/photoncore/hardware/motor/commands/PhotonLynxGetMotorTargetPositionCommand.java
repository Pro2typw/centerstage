...
public class PhotonLynxGetMotorTargetPositionCommand extends LynxGetMotorTargetPositionCommand implements PhotonCommandBase {
    private final CompletableFuture<LynxMessage> future = new CompletableFuture<>();

    public PhotonLynxGetMotorTargetPositionCommand(LynxModuleIntf module, int motorZ) {
        super(module, motorZ);
    }
