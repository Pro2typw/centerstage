...
import org.firstinspires.ftc.teamcode.justbetter.util.Angle;
import org.firstinspires.ftc.teamcode.justbetter.util.AngleDegrees;
import org.firstinspires.ftc.teamcode.justbetter.util.AngleRadians;
import org.firstinspires.ftc.teamcode.justbetter.util.HeadingSupplier;
 ...
 */
public class IMU implements com.qualcomm.robotcore.hardware.IMU, HeadingSupplier {
	 ...
	 */
	public IMU(com.qualcomm.robotcore.hardware.IMU imu, AngleUnit angleUnit) {
		this.imu = imu;
	...
	/**
	 * resets the yaw using {@link com.qualcomm.robotcore.hardware.IMU#resetYaw()} and by updating the offset
	 */
