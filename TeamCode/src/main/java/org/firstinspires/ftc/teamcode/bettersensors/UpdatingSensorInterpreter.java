...
public abstract class UpdatingSensorInterpreter {
     ...
     */
    public UpdatingSensorInterpreter(com.wolfpackmachina.bettersensors.Sensor pingSyncProvider){
     ...
     * @param pingSyncProvider
     */
    public void syncUpdateFrequency(com.wolfpackmachina.bettersensors.Sensor pingSyncProvider){
