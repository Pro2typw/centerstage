...
public class BluePropDetectionCvPipeline extends OpenCvPipeline {
    ...
    public Mat processFrame(Mat frame) {
        ...
        Imgproc.rectangle(frame, CENTER_RECTANGLE, rectColor, 10);
        Imgproc.rectangle(frame, LEFT_RECTANGLE, rectColor, 10);
        Imgproc.rectangle(frame, RIGHT_RECTANGLE, rectColor, 10);
