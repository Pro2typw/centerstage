...
public class PhotonLynxSetMotorConstantPowerCommand extends LynxSetMotorConstantPowerCommand implements PhotonCommandBase {
    private final CompletableFuture<LynxMessage> future = new CompletableFuture<>();

    public PhotonLynxSetMotorConstantPowerCommand(LynxModuleIntf module, int motorZ, int power) {
        super(module, motorZ, power);
    }
    ...
    public int getCommandNumber() {
        ...
        return theInterface.getBaseCommandNumber() + 15;
    }
}
