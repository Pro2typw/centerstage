...
//                                    claw.setLeftClawState(Claw.ClawState.OPEN);
                                        ...
                                        .waitSeconds(1.5)
                                        .splineToLinearHeading(new Pose2d(28, 11.3, Math.toRadians(180)), Math.toRadians(180))
                                        ...
                                        .splineToLinearHeading(new Pose2d(46, 27.4, Math.toRadians(180)), Math.toRadians(90))
                                        .addDisplacementMarker(() -> {
                                            // Place pixel on backdrop
                                        })
                                        .waitSeconds(1.5)
